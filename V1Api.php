...
class V1Api {
    ...
    public function authenticateUser($username, $password) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/authenticateUser";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
...
* CUSTOM
*/
    public function compressFiles($access_token, $filePaths, $archivePath) {
        $resourcePath = "/v1.2/compressFiles";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
...
*/
    ...
    public function checkFilesExist($access_token, $filePaths) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/checkFilesExist";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function copyResources($access_token, $filePaths, $destinationPath) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/copyResources";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function createFolder($access_token, $folderName, $path) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/createFolder";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function createNotification($access_token, $path, $action, $usernames, $sendEmail, $emails=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/createNotification";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function deleteNotification($access_token, $id) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/deleteNotification";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function deleteResources($access_token, $filePaths) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/deleteResources";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getCurrentUser($access_token) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getCurrentUser";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getDownloadFileUrl($access_token, $filePaths, $downloadName=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getDownloadFileUrl";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getFileActivityLogs($access_token, $filterBy=null, $filter=null, $itemLimit=null, $offset=null, $sortBy=null, $sortOrder=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getFileActivityLogs";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getNotification($access_token, $id) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getNotification";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getNotifications($access_token, $type, $sortBy=null, $sortOrder=null, $filter=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getNotifications";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getNotificationActivity($access_token) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getNotificationActivity";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getResourceList($access_token, $path, $sortBy, $sortOrder, $offset, $limit, $detailed=null, $pattern=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getResourceList";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getResourceProperties($access_token, $filePaths) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getResourceProperties";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getShareActivity($access_token, $id) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getShareActivity";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function getUploadFileUrl($access_token, $fileSize, $destinationPath, $allowOverwrite=null, $resume=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/getUploadFileUrl";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function moveResources($access_token, $filePaths, $destinationPath) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/moveResources";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function renameResource($access_token, $filePath, $newName) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/renameResource";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function updateNotification($access_token, $id, $path=null, $action=null, $usernames=null, $emails=null, $sendEmail=null) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/updateNotification";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
    ...
    public function userAvailable($access_token, $username) {
        ...
        // parse inputs
        $resourcePath = "/v1.2/userAvailable";
        $method = "POST";
        $queryParams = array();
        $headerParams = array();
        $headerParams['Accept'] = '(mediaType,application/json)';
